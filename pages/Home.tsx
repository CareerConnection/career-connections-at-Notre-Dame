...
const Home: React.FC = () => {
  return (
    <div className="flex flex-col items-center justify-center h-screen">
      ...
      <p className="max-w-xl text-lg text-center mt-2">
        Find class reviews and syllabuses easily.
      </p>
      <div className="flex flex-row gap-2 mt-4">
        ...
        <Link
          href="https://www.loom.com/share/9257fe4c3af649bcaf4db4de1f352ba4?sid=a9e4d052-6f82-41a0-99af-bbddd0ed9f93"
          target="_blank"
        >
