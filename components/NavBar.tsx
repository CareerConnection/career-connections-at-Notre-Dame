      ...
      <div className="w-full flex mx-4 py-4 items-center justify-center">
        ...
        <div className="flex w-full max-w-5xl items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            <Link
              href="/Courses"
              className="hover:text-gray-500 transition-all duration-200 ease-out"
            >
              Courses
            </Link>
            ...
            <Link
              href="https://github.com/CareerConnection/career-connections-at-Notre-Dame"
              target="_blank"
              className="hover:text-gray-500 transition-all duration-200 ease-out"
            >
              GitHub
            ...
            {isLoggedIn ? (
              <div
                ...
                className="flex items-center justify-center px-4 py-2 bg-gray-200 text-black rounded-md cursor-pointer hover:bg-gray-400 transition-all duration-200 ease-out"
              >
                Log out
              </div>
            ) : (
